...
PdiBaseViewElement = class("PdiBaseViewElement", "ViewElementBase")

PdiBaseViewElement._generate_ui_offscreen_renderers = function(self, number_of_renderers)
    ...
    if number_of_renderers > 3 then
        ...
        for i = 1,number_of_renderers,1 do
            ...
            self["viewport_"..i] = viewport
            local ui_offscreen_renderer_name = class_name .. "_ui_offscreen_renderer_"..i
            self["_ui_offscreen_renderer_"..i.."_name"] = ui_offscreen_renderer_name
            self["_ui_offscreen_renderer_"..i] = ui_manager:create_renderer(ui_offscreen_renderer_name, world)
        end
    end
end
PdiBaseViewElement._destroy_ui_offscreen_renderers = function(self)
    for i = 1,3,1 do
        if self["_ui_offscreen_renderer_"..i] then
			self["_ui_offscreen_renderer_"..i] = nil

            local world = self["_world_"..i]

            Managers.ui:destroy_renderer(self["_ui_offscreen_renderer_"..i.."_name"])
            ScriptWorld.destroy_viewport(world, self["_viewport_"..i.."_name"])
            ...
            self["_world_"..i] = nil
            self["_viewport_"..i.."_name"] = nil
            self["viewport_"..i] = nil
            self["_ui_offscreen_renderer_"..i.."_name"] = nil
            
        end
    end
end
PdiBaseViewElement._create_dropdown_widget = function(self, widget_name, scenegraph_id, options, max_visible_options, on_changed_callback, nothing_selected_text)
